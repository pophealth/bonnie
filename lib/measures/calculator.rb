module Measures
  class Calculator
    ...
    def self.measure_js(measure, population_index)
      HQMF2JS::Generator::Execution.measure_js(measure, population_index, APP_CONFIG['check_crosswalk'])
    end
    
    def self.execution_logic(measure, population_index=0, load_codes=false)
      HQMF2JS::Generator::Execution.logic(measure, population_index, load_codes, APP_CONFIG['check_crosswalk'])
    end
