...
class ValueSetParserTest < Test::Unit::TestCase
  ...
  def setup
    @sample = [
      [ "Value Set Developer", "Value Set OID", "Last Mod", "Value Set Name", "QDM Category", "Code System", "Code System Version", "Code", "Descriptor"],
      ["National Committee for Quality Assurance", "2.16.840.1.113883.3.464.0001.14", nil, "birth date", "Individual characteristic", "HL7", "3.0", "00110", "Date/Time of birth (TS)"],
      ["National Committee for Quality Assurance", "2.16.840.1.113883.3.464.0001.14", nil, "birth date", "Individual characteristic", "HL7", "3.0", "00112", "Date/Time of birth (TS)"],
      ["National Committee for Quality Assurance", "2.16.840.1.113883.3.464.0001.48", nil, "encounter outpatient", "Encounter", "CPT", "06/2009", "99201", nil],
      ["National Committee for Quality Assurance", "2.16.840.1.113883.3.464.0001.48", nil, "encounter outpatient", "Encounter", "CPT", "06/2009", "99202", nil], 
      ["National Committee for Quality Assurance", "2.16.840.1.113883.3.464.0001.48", nil, "encounter outpatient", "Encounter", "CPT", "06/2009", "99209-99215", nil], 
      ["National Committee for Quality Assurance", "2.16.840.1.113883.3.464.0001.47", nil, "encounter outpatient", "Encounter", "CPT", "06/2009", "99201", nil],
      ["National Committee for Quality Assurance", "2.16.840.1.113883.3.464.0001.49", nil, "encounter outpatient", "Encounter", "GROUPING", "n/a", "2.16.840.1.113883.3.464.0001.48", '"encounter outpatient" CPT code list'],
      ["National Committee for Quality Assurance", "2.16.840.1.113883.3.464.0001.49", nil, "encounter outpatient", "Encounter", "GROUPING", "n/a", "2.16.840.1.113883.3.464.0001.47", '"encounter outpatient" CPT code list']
    ]
  ...
  def test_it_reads_a_file_to_array
    ...
    sheet = vsp.send(:file_to_array, file)
