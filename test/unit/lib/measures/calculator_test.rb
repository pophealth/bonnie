...
class CalculatorTest < ActiveSupport::TestCase  
  ...
  test "measure json" do
    ...
    expected_keys = [:id,:nqf_id,:hqmf_id,:hqmf_set_id,:hqmf_version_number,:endorser,:name,:description,:type,:category,:steward,:population,:denominator,:numerator,:exclusions,:map_fn,:population_ids,:data_criteria,:oids, :continuous_variable, :episode_of_care]
